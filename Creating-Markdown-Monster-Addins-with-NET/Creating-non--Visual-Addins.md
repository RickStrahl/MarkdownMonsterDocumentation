...
As with a regular addin you have to override `OnApplicationStart()` to initialize the add-in but you only set the `Id` and `Name` properties. Then go ahead and override any hook methods.

...
### Auto-Backup
Auto-Backup backs up typed content as you type in a `*.md.saved.bak` backup file. Whenever you save the main markdown file, the backup file is deleted.
...
This feature is controlled via the `AutoSaveBackups` configuration setting in **Tools -> Settings**.

```json
"AutoSaveBackups": true,
```  

> #### @icon-info-circle Recovery Files and Git
